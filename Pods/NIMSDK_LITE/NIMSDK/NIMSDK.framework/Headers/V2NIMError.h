...
typedef NS_ENUM(NSInteger, V2NIMErrorCode) {
    ...
    V2NIM_ERROR_CODE_AUTO_LOGIN_FORBIDDEN                 = 417,  ///< 自动登录被禁止
    ...
    V2NIM_ERROR_CODE_DISCONNECT                           = 192002,  ///< 连接断开
    V2NIM_ERROR_CODE_PROTOCOL_TIMEOUT                     = 192003,  ///< 协议超时
    V2NIM_ERROR_CODE_PROTOCOL_SEND_FAILED                 = 192004,  ///< 协议发送失败
