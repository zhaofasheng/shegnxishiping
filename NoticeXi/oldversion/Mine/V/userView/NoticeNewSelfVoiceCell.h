...
@protocol NoticeNewSelfVoiceListClickDelegate <NSObject>
@optional
...
@interface NoticeNewSelfVoiceCell : BaseCell<NoticeShareToWorldSuccess,NoticePinbiClickSuccess,LCActionSheetDelegate,NoticeBBSComentInputDelegate>
@property (nonatomic, weak) id<NoticeNewSelfVoiceListClickDelegate>delegate;
