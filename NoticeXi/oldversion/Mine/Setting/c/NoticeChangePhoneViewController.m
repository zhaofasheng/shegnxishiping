    ...
    if (self.isThird && self.type == 2) {
        ...
        showV.choicebtnTag = ^(NSInteger tag) {
            if (tag == 1) {
                ...
                [self.getCodeBtn setAction];
                self.getCodeBtn.titleLabel.font = TWOTEXTFONTSIZE;
                [self.getCodeBtn setTitleColor:[UIColor colorWithHexString:@"#00ABE4"] forState:UIControlStateNormal];
...
- (void)countdownButtonDidEndCountdown:(CQCountdownButton *)countdownButton {
    [countdownButton setAttributedTitle:[DDHAttributedMode setColorString:[NoticeTools getLocalStrWith:@"Login.getsmsCode"] setColor:[UIColor colorWithHexString:@"#00ABE4"] setLengthString:[NoticeTools getLocalStrWith:@"Login.getsmsCode"] beginSize:0] forState:UIControlStateNormal];
    [countdownButton setTitleColor:[UIColor colorWithHexString:@"#00ABE4"] forState:UIControlStateNormal];
