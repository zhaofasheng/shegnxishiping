...
@protocol NoticeClockClickDelegate <NSObject>
@optional
...
@interface NoticePyCell : BaseCell<NoticePlayerNumbersDelegate,NoticeClockButtonDelegate,NoticeManagerUserDelegate,LCActionSheetDelegate>
@property (nonatomic, strong) NoticeClockPyModel *pyModel;
@property (nonatomic, weak) id <NoticeClockClickDelegate>delegate;
