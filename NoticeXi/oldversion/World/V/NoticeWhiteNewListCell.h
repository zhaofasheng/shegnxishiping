...
@protocol NoticeWhiteNewVoiceListClickDelegate <NSObject>
@optional
...
@interface NoticeWhiteNewListCell : BaseCell<NoticePlayerNumbersDelegate,NoticePinbiClickSuccess,NoticeRecordDelegate,NewSendTextDelegate,NoticeBBSComentInputDelegate>

@property (nonatomic, strong) NoticeVoiceListModel *voiceM;
@property (nonatomic, weak) id<NoticeWhiteNewVoiceListClickDelegate>delegate;
