...
@interface NoticePlayBokeTimeSetView : UIView
...
@property (nonatomic, copy) void(^choiceTimeBlock)(NSString *formtTime,NSString *hour,NSString *min,NSInteger time);
