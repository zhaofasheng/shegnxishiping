...
@property (nonatomic, strong) NSString *is_recommend;//本人是否推荐
@property (nonatomic, strong) NSString *is_black;//是否拉黑
@property (nonatomic, strong) NSString *recommend_num;//推荐人数总数
