...
@implementation SXShopSayComModel
...
- (void)setReply:(NSDictionary *)reply{
    _reply = reply;
    self.firstReplyModel = [SXShopSayComModel mj_objectWithKeyValues:reply];
...
- (void)setComment:(NSDictionary *)comment{
    _comment = comment;
    self.firstCommentModel = [SXShopSayComModel mj_objectWithKeyValues:comment];
