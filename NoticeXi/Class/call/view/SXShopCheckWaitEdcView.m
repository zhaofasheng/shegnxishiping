...
@implementation SXShopCheckWaitEdcView
...
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        UIView *contentView = [[UIView  alloc] initWithFrame:CGRectMake(15, 97, DR_SCREEN_WIDTH-30, 242+imageHeight*2+45)];
        ...
        NSArray *titleArr = @[@"姓名",@"身份证号",@"学历",@"学校全称",@"专业名称"];
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (i < 3) {
                ...
                if (i == 0) {
                    ...
                    imageView.frame = CGRectMake(CGRectGetMaxX(self.zmImageView.frame)+15, 242, imageWidth, imageHeight);
