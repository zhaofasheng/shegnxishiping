...
@protocol NoticeOrderChatDeledate <NSObject>
...
@interface SXOrderChatCell : BaseCell<NoticePlayerNumbersDelegate>
@property (nonatomic, weak) id<NoticeOrderChatDeledate>delegate;
