...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(mainTableViewWillBeginDraggingScroll:)]) {
        [self.delegate mainTableViewWillBeginDraggingScroll:scrollView];
    }
}
