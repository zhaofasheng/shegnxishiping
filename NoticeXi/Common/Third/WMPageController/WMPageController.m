...
- (void)wm_addScrollView {
    ...
    //scrollView.backgroundColor = [[UIColor whiteColor] colorWithAlphaComponent:0];
...
- (void)wm_addMenuView {
    ...
    menuView.needItemBackColor = self.needItemBackColor;
    menuView.itemBackColor = self.itemBackColor;
...
#pragma mark - UIScrollView Delegate //滑动距离
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (_startDragging) {
        ...
        [self getCurrentScrollSet:contentOffsetX];
    }
...
#pragma mark - WMMenuView Delegate  //点击按钮选择控制器
