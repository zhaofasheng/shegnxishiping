...
- (void)viewDidLayoutSubviews {
    ...
    _doneButton.frame = CGRectMake((self.view.tz_width - _doneButton.tz_width)/2, 0, MAX(44, _doneButton.tz_width), 44);
    _numberImageView.frame = CGRectMake(_doneButton.tz_right, 10, 24, 24);
