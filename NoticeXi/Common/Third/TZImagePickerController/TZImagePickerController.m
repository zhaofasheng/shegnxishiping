...
- (void)configNavigationBarAppearance {
    if (@available(iOS 13.0, *)) {
        ...
        if (self.navigationBar.isTranslucent) {
            ...
            barAppearance.backgroundColor = [barTintColor colorWithAlphaComponent:1];
        } else {
...
- (void)configDefaultSetting {
    ...
    self.naviTitleColor = [UIColor colorWithHexString:@"#25262E"];
    self.naviTitleFont = [UIFont systemFontOfSize:17];
    self.barItemTextFont = [UIFont systemFontOfSize:15];
    self.barItemTextColor = [UIColor colorWithHexString:@"#25262E"];
