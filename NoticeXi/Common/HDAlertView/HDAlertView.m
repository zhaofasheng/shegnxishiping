...
- (void)updateSubviewsFrame {
    if (self.alertViewStyle == HDAlertViewStyleActionSheet) {
        ...
        CGFloat titleLabelH = self.title.length? 64.0:0;
        ...
        CGFloat margin =self.title.length? 25.0:0;
        ...
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0,CGRectGetMaxY(self.messageLabel.frame) + margin,containerViewW,1)];
...
- (void)createSubviews {
    ...
    titleLabel.textColor = GetColorWithName(VMainTextColor);
...
- (UIButton *)buttonForItemIndex:(NSUInteger)index {
    ...
    [button setBackgroundImage:[UIImage hd_imageWithColor:[[UIColor whiteColor] colorWithAlphaComponent:1]] forState:UIControlStateNormal];
    ...
    switch (item.type) {
        ...
        default:
            ...
            [button setTitleColor:index == 0? [UIColor colorWithHexString:WHITEMAINCOLOR] :[UIColor colorWithHexString:@"#666666"]  forState:UIControlStateNormal];
            break;
        }
    }
...
- (void)setViewBackgroundColor:(UIColor *)viewBackgroundColor {
    ...
    self.containerView.backgroundColor = GetColorWithName(VBackColor);
}
...
- (void)setTitleFont:(UIFont *)titleFont {
    ...
    self.titleLabel.font = FIFTHTEENTEXTFONTSIZE;
}
...
+ (HDAlertView *)showActionSheetWithTitle:(NSString *)title {
    ...
    alertView.backgroundColor = GetColorWithName(VBackColor);
    alertView.isSupportRotating = YES;
