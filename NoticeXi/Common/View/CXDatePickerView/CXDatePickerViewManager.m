...
- (void)defaultConfig {
    ...
    if (!self.maxLimitDate) {
        self.maxLimitDate = [NSDate cx_date:@"2023-12-31 23:59:00" WithFormat:@"yyyy-MM-dd HH:mm:ss"];
    }
    //最小限制
    if (!self.minLimitDate) {
        self.minLimitDate = [NSDate cx_date:@"2017-01-01 00:00:00" WithFormat:@"yyyy-MM-dd HH:mm:ss"];
    }
}
