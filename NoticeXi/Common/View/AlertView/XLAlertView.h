...
- (instancetype _Nullable )initWithTitle:(NSString *_Nullable)title name:(NSString *_Nonnull)name time:(NSString *_Nullable)time creatTime:(NSInteger)creatTime autoNext:(BOOL)autonext avageTime:(NSInteger)avageTime;
