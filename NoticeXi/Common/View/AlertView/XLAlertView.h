...
@property (nonatomic, assign) NSInteger waittime2;
@property (nonatomic, assign) NSInteger waittime3;
@property (nonatomic, assign) NSInteger firstWaittime;
@property (nonatomic, assign) NSInteger secondWaittime;
@property (nonatomic, assign) NSInteger thirdWaittime;
@property (nonatomic, assign) NSInteger alltime;
@property (nonatomic, assign) NSInteger avagetime;
@property (nonatomic, assign) BOOL autoNext;
@property (nonatomic, assign) BOOL cancelAutoNext;
@property (nonatomic, strong) NSString * _Nonnull name;
- (instancetype _Nullable )initWithTitle:(NSString *_Nullable)title name:(NSString *_Nonnull)name time:(NSString *_Nullable)time creatTime:(NSInteger)creatTime autoNext:(BOOL)autonext avageTime:(NSInteger)avageTime isExperince:(BOOL)isExperince;
