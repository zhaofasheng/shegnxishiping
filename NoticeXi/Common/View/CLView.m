...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.sheetBtn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, frame.size.width, 50)];
        ...
        self.sheetLab = [[UILabel alloc]initWithFrame:CGRectMake(0, 60, frame.size.width, 20)];
        ...
        self.sheetLab.textColor = GetColorWithName(VMainTextColor);
