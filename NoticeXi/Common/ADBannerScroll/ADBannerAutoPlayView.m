...
- (void)initViews
{
    ...
    self.bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, (DR_SCREEN_WIDTH-40)*3/4, DR_SCREEN_WIDTH-40, 0)];
    [self addSubview:self.bottomView];
    self.bottomView.backgroundColor = [[UIColor colorWithHexString:@"#14151A"] colorWithAlphaComponent:0.4];
